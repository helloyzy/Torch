...
#define COCOAPODS_VERSION_PATCH_InnerBand 5
...
// SKBindingManager
#define COCOAPODS_POD_AVAILABLE_SKBindingManager
#define COCOAPODS_VERSION_MAJOR_SKBindingManager 1
#define COCOAPODS_VERSION_MINOR_SKBindingManager 0
#define COCOAPODS_VERSION_PATCH_SKBindingManager 0
