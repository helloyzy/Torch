...
+ (void) displayAuthenticateView:(UIViewController *)vc {
    ...
    if (deviceType == UIUserInterfaceIdiomPhone) {
        authenticateView_iPhone *authenticateView = [[authenticateView_iPhone alloc] initWithNibName:@"authenticateView_iPhone" bundle:nil];
        [vc presentModalViewController:authenticateView animated:YES];
    } else {
        authenticateView_iPad *authenticateView = [[authenticateView_iPad alloc] initWithNibName:@"authenticateView_iPad2" bundle:nil];
